...
export default function Sidebar({ user, isSidebarOpen, handleLogout }) {
  ...
  const menuItems = [
    ...
    { name: "Settings", path: "/settings", icon: Settings, roles: [Role.ADMIN, Role.DOCTOR, Role.RECEPTIONIST, Role.LAB, Role.PHARMACY] },
  ];
      ...
      <div className="h-full flex flex-col overflow-hidden">
        ...
        <div className="h-20 flex items-center px-6 border-b border-gray-50 flex-shrink-0">
          <div className="flex items-center gap-3">
            <img src={logoBireena} alt="Logo" className="h-12 object-contain rounded-xl" />
            <span className={cn(
