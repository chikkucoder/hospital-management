...
export default function Login() {
  ...
  const getDemoCredentials = (selectedRole) => {
    switch(selectedRole) {
      ...
      case "Receptionist": return { email: "reception.medico", password: "medicouserreception" };
      case "Lab": return { email: "lab.medico", password: "medicouserlab" };
      case "Pharmacy": return { email: "pharmacy.medico", password: "medicouserpharmacy" };
  ...
  return (
    <div className="min-h-screen bg-bg-primary flex flex-col items-center justify-center p-6 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] relative text-primary-dark">
      ...
      >
        <Link to="/" className="transition-transform hover:-translate-y-2 duration-300">
          <img src={logoBireena} alt="Logo" className="w-80 object-contain rounded-xl" />
        </Link>
      </motion.div>
      ...
      >
        <div className="p-8 pb-4">
          ...
          <div className="relative mb-6">
            ...
            <AnimatePresence>
              {showDropdown && (
                ...
                >
                  <div className="px-4 py-2 text-[10px] font-black text-gray-400 uppercase tracking-widest bg-bg-primary/50 border-b border-bg-primary">Admin</div>
                  <button
                  ...
                  <div className="px-4 py-2 text-[10px] font-black text-gray-400 uppercase tracking-widest bg-bg-primary/50 border-b border-bg-primary">Doctor</div>
                  <button
                  ...
                  <div className="px-4 py-2 text-[10px] font-black text-gray-400 uppercase tracking-widest bg-bg-primary/50 border-b border-bg-primary">Staff</div>
                  <button
          ...
          <p className="text-sm text-gray-500 mb-8">
            Selected Portal: <strong className="text-primary-dark font-bold">{role}</strong>
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-sm font-bold text-primary-dark ml-1">Username / ID</label>
            ...
            <div className="space-y-2">
              <label className="text-sm font-bold text-primary-dark ml-1">Security Key</label>
              <div className="relative group">
        ...
        <div className="p-8 bg-bg-primary border-t border-primary/10 flex flex-col items-center gap-4">
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <div className="flex gap-4">
               <code className="text-[10px] text-primary font-bold bg-bg-secondary px-2 py-1 rounded-md border border-primary/10">{demoCreds.email}</code>
               <code className="text-[10px] text-primary font-bold bg-bg-secondary px-2 py-1 rounded-md border border-primary/10">{demoCreds.password}</code>
            </div>
          </div>
        </div>
      </motion.div>
